function Controller() {
    ...
    $.__views.artists.add($.__views.__alloyId75);
    ...
    $.__views.topNav.add($.__views.__alloyId76);
    var __alloyId77 = [];
    $.__views.categoriesScreen = Ti.UI.createView({
        id: "categoriesScreen"
    });
    __alloyId77.push($.__views.categoriesScreen);
    ...
    __alloyId77.push($.__views.videosScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    __alloyId77.push($.__views.artistsScreen);
    $.__views.activity = Ti.UI.createActivityIndicator({
        color: "#6cb1d5",
        font: {
            fontFamily: "Helvetica Neue",
    ...
    $.scrollableView.addEventListener("scrollend", function() {
        ...
        2 == $.scrollableView.currentPage && 0 == artists.children.length && data.getArtists($.activity, artists, 0, 0, categoryId);
    });
