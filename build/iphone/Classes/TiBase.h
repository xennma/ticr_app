...
// in simulator we redefine to format for Ticr Developer console
...
{\
	NSString * exceptionName = [@"org.ticr." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ticr";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITicrNativeItemNone = -1, 
	UITicrNativeItemSpinner = -2,
	UITicrNativeItemProgressBar = -3,
	
	UITicrNativeItemSlider = -4,
	UITicrNativeItemSwitch = -5,
	UITicrNativeItemMultiButton = -6,
	UITicrNativeItemSegmented = -7,
	
	UITicrNativeItemTextView = -8,
	UITicrNativeItemTextField = -9,
	UITicrNativeItemSearchBar = -10,
	
	UITicrNativeItemPicker = -11,
	UITicrNativeItemDatePicker = -12,
	
	UITicrNativeItemInfoLight = -13,
	UITicrNativeItemInfoDark = -14,
	
	UITicrNativeItemDisclosure = -15,
	
	UITicrNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ticr instances of
